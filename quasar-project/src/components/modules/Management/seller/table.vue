<template>
   ...
   export default {
     ...
     { label: 'Email', field: 'Email', name:'Email',  align:'' },
       ...
       { label: 'Mobile number', field: 'Mobile_number', name:'',  align:'' },
       ...
       { label: 'State', field: 'state', name:'address' , align:''},
       { label: 'City', field: 'city', name:'address' , align:''},
       { label: 'Pincode', field: 'pincode', name:'address' , align:''},
